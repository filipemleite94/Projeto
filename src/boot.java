...
public class boot extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == jbRemove) {
			Ag.remover(jlList.getSelectedValue().toString());
			files.remove(jlList.getSelectedIndex());
			
		}
		if (source == jbOpen) {
			if (jlList.getSelectedValue() != null) {
				jtText.setText(jlList.getSelectedValue().toString());
		...
		if (source == jbSave) {
			Ag.save(jtName.getText(), jtMetaTag.getText(), jtText.getText(),
